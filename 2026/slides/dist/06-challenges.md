<!-- .slide: class="center-slide section-divider" data-background-color="#450a0a" -->

<div style="font-size: 3.5em; margin-bottom: 10px;">⚠️</div>

## Challenges & <span style="color: #fca5a5;">Anti-Patterns</span> <!-- .element: style="color: #e2e8f0;" -->

What can go wrong — and how to avoid it <!-- .element: style="color: #94a3b8; font-size: 0.75em;" -->

Note:
Section divider. We shift from "how to do it right" to "what kills clusters."
