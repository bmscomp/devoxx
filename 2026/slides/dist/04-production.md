<!-- .slide: class="center-slide section-divider" data-background-color="#052e16" -->

<div style="font-size: 3.5em; margin-bottom: 10px;">🏭</div>

## Kafka with <span style="color: #4ade80;">KRaft</span> in Production <!-- .element: style="color: #e2e8f0;" -->

What it really takes to run Kafka at scale <!-- .element: style="color: #94a3b8; font-size: 0.75em;" -->

Note:
Section divider. From theory to practice — real production deployments.
...
<div class="card card-danger" style="text-align: center; border-top: 3px solid var(--accent-red);">
<h4 class="accent-red">ZooKeeper Era</h4>
<div style="font-size: 4em; font-weight: 900; color: var(--accent-red); line-height: 1.1;">14</div>
<p style="margin-top: 10px;">Components to operate, monitor, and secure</p>
<p style="font-size: 0.75em; color: #94a3b8;">ZK nodes + Kafka brokers + controller + configs + monitoring × 2</p>
</div>
<div class="card card-success" style="text-align: center; border-top: 3px solid var(--accent-green);">
<h4 class="accent-green">KRaft Era</h4>
<div style="font-size: 4em; font-weight: 900; color: var(--accent-green); line-height: 1.1;">5</div>
<p style="margin-top: 10px;">Components — one system, one team</p>
<p style="font-size: 0.75em; color: #94a3b8;">KRaft controllers + Kafka brokers + single config</p>
</div>
</div>

Note:
Let the numbers speak. 14 vs 5. That's the operational simplification.
